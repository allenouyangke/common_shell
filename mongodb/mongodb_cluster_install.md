...
三台服务器：192.168.0.1/2/3

安装包： mongodb-linux-x86_64-3.4.6.tgz

服务器规划

|    server1    |   server02    |   server03    |
| :-----------: | :-----------: | :-----------: |
...
启动三台服务器的config server，`注意：每个节点启动成功再执行下一步配置副本集操作`
...
启动三台服务器的shard1 server,`注意：每个节点启动成功再执行下一步配置副本集操作`
...
启动三台服务器的shard2 server,`注意：每个节点启动成功再执行下一步配置副本集操作`
...
启动三台服务器的shard3 server,`注意：每个节点启动成功再执行下一步配置副本集操作`
...
[参考资料](http://www.ityouknow.com/mongodb/2017/08/05/mongodb-cluster-setup.html)

注意关闭mongo不能直接 kill -9  ： [相关资料](https://www.cnblogs.com/joshua317/articles/5190385.html)